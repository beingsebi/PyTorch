...
---
Again, it's best to learn via examples. Let's build a basic algorithm that given some `(x,y)` pairs to *study* is able to
<!--stackedit_data:
eyJoaXN0b3J5IjpbNjQ4ODUyODkxLDE2NjUzOTQzMTgsMTU2MT
