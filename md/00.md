...
The [`torch.size(dim=None)`](https://pytorch.org/docs/stable/generated/torch.Tensor.size.html?highlight=tensor+size#torch.Tensor.size) method is [equivalent to](https://github.com/pytorch/pytorch/issues/5544) the `torch.shape` attribute of the tensor. [`torch.device`](https://pytorch.org/docs/stable/tensor_attributes.html?highlight=device#torch.device) is an object representing where the tensor is or will be allocated. Default is CPU.
` t = torch.tensor(data=[[1,2,3]],device='cpu')
print(t.size(),t.device,sep='\n')

torch.Size([1, 3])
cpu`
<!--stackedit_data:
eyJoaXN0b3J5IjpbNjI3ODA4Nzc1LDEzNTIyMDIyNTUsLTIwNj
Y4OTQxMjcsLTEzNTg1NDQ4MDksMTY3OTUzNzA3NCwtMjczMDE0
NjI0LDMyOTYwNTM3NywtMTk4MjUzNDM0OCwtMTk5MTU3OTMwNS
wxNDA4NzM2NTQ1LC0xODMyODQxOTI4LDEzMDgyNzU5MjcsLTEz
NjY4Mzg0NDMsLTg2MjMwNDg2Myw4Njg5MDg4MDksMTQwODc3MT
QwMywtODgzOTc3MTI5LDE0Mjk1NDY2ODAsNDQwOTc1NzI3LC0z
NzcwMDYyMTFdfQ==
-->