...
You can explicitly choose the datatype for your tensor using the [attribute](https://pytorch.org/docs/stable/tensor_attributes.html) `torch.` 


<!--stackedit_data:
eyJoaXN0b3J5IjpbOTkwNjU3NzYyLDE2Nzk1MzcwNzQsLTI3Mz
