...
You can explicitly choose the [datatype](https://pytorch.org/docs/stable/tensors.html#data-types) for your tensor using the [attribute](https://pytorch.org/docs/stable/tensor_attributes.html) [`torch.dtype`]() 


<!--stackedit_data:
eyJoaXN0b3J5IjpbMTI2OTI4MjYwMywxNjc5NTM3MDc0LC0yNz
