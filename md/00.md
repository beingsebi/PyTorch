...
### Tensor transpose
If the tensor is 2D (a matrix), you can access its transpose via `tensor.T`, but this actually works for any kind of tensor. You 
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTkzNjIzNjgzMiwyMDc2ODU3NjM4LC03Mj
