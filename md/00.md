...
The [`torch.size(dim=None)`](https://pytorch.org/docs/stable/generated/torch.Tensor.size.html?highlight=tensor+size#torch.Tensor.size) method is [equivalent to](https://github.com/pytorch/pytorch/issues/5544) the `torch.shape` attribute of the tensor. [`torch.device`](https://pytorch.org/docs/stable/tensor_attributes.html?highlight=device#torch.device)
<!--stackedit_data:
eyJoaXN0b3J5IjpbOTUwOTExNjg2LC0yMDY2ODk0MTI3LC0xMz
U4NTQ0ODA5LDE2Nzk1MzcwNzQsLTI3MzAxNDYyNCwzMjk2MDUz
NzcsLTE5ODI1MzQzNDgsLTE5OTE1NzkzMDUsMTQwODczNjU0NS
wtMTgzMjg0MTkyOCwxMzA4Mjc1OTI3LC0xMzY2ODM4NDQzLC04
NjIzMDQ4NjMsODY4OTA4ODA5LDE0MDg3NzE0MDMsLTg4Mzk3Nz
EyOSwxNDI5NTQ2NjgwLDQ0MDk3NTcyNywtMzc3MDA2MjExLC0y
MTQ2MDA2MTg0XX0=
-->